...
String cascadeName =
"/home/aaroncz/OpenCV/OpenCV-2.4.2/data/haarcascades/haarcascade_frontalface_alt.xml";
String nestedCascadeName =
"/home/aaroncz/OpenCV/OpenCV-2.4.2/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml";
 ...
 drone_image()
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
     sensor_msgs::CvBridge bridge;//we need this object bridge for facilitating conversion from ros-img to opencv
      ...
      IplImage* frame = cvCreateImage( cvGetSize(img), IPL_DEPTH_8U, 3 );   //make sure to feed the image(img) data to the parameters 	necessary for canny edge output 
...
int track( int argc, const char** argv )
{
    CvCapture* capture = 0;
